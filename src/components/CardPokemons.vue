...
const updateVisibility = (value) => emit('update:visible', value);

const toggleFavorite = (pokemon) => pokeStore.toggleFavorite(pokemon.name);
...
<template>
    <Dialog class="custom-dialog" :visible="visible" @update:visible="updateVisibility" :style="{ maxWidth: '600px', width: '100%' }" :closable="true" :modal="true">
        ...
        <div class="content">
            ...
            <div class="button-container">
                ...
                <i class="pi" :class="pokeStore.favorites.has(pokemon.name) ? 'pi-star-fill text-yellow-500' : 'pi-star text-gray-500'" @click="toggleFavorite(pokemon)" />
            </div>
        </div>
    </Dialog>
    <Toast />
